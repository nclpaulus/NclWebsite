...
export const experiments: LabExperiment[] = [
	{
		...
		problem: 'Comment permettre aux utilisateurs de basculer entre différents contextes (professionnel/personnel) avec une expérience utilisateur fluide ?',
		solution: 'Implémentation d\'un sélecteur de profil avec animations CSS personnalisées, stockage local et transitions Svelte',
	...
	},
	{
		...
		problem: 'Comment consommer une API externe (PokéAPI) avec SvelteKit en utilisant les server-side functions ?',
		solution: 'Utilisation de +page.server.ts pour charger les données côté serveur, gestion des erreurs et affichage conditionnel',
	...
	},
	{
		...
		problem: 'Comment développer rapidement des composants UI avec documentation intégrée et prévisualisation en direct ?',
		solution: 'Création d\'un système de composants avec shadcn-svelte, documentation automatique et playground interactif',
	...
	},
	{
		...
		problem: 'Comment migrer un projet existant de Tailwind v3 à v4 en conservant tous les styles et en adoptant les nouvelles fonctionnalités ?',
		solution: 'Migration progressive avec @theme inline, optimisation des performances et mise à jour des composants shadcn',
	...
	},
	{
		...
		problem: 'Comment créer des formulaires complexes avec validation sans écrire de code répétitif ?',
		solution: 'Système de configuration JSON pour générer des formulaires avec validation automatique et types sécurisés',
