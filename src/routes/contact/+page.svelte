...
<div class="container mx-auto px-4 py-8">
	...
	<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
				...
				<div class="relative">
					...
					<div class="relative">
						...
						{#if formData.name.trim().length > 0}
							<div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-green-500 animate-pulse">
		...
		<div class="space-y-6">
			...
			<div class="group bg-linear-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl p-5 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
				<div class="flex items-center gap-4">
					<div class="relative">
						<div class="w-12 h-12 bg-primary rounded-full flex items-center justify-center text-primary-foreground">
							📧
						</div>
					...
					<div class="flex-1">
						...
						<p class="text-xs text-primary mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
							Réponse sous 24-48h
						</p>
					</div>
				</div>
			...
			<!-- Carte Localisation -->
			<div class="group bg-linear-to-br from-secondary/5 to-secondary/10 border border-secondary/20 rounded-xl p-5 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
				<div class="flex items-center gap-4">
					<div class="relative">
						<div class="w-12 h-12 bg-secondary rounded-full flex items-center justify-center text-secondary-foreground">
							📍
						</div>
						<div class="absolute -bottom-1 -right-1 w-6 h-6 bg-secondary/20 rounded-full flex items-center justify-center">
					...
					<div class="flex-1">
						...
						<p class="text-xs text-secondary mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
			...
			<!-- Carte Disponibilité -->
			<div class="group bg-linear-to-br from-accent/5 to-accent/10 border border-accent/20 rounded-xl p-5 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
				<div class="flex items-center gap-4">
					<div class="relative">
						<div class="w-12 h-12 bg-accent rounded-full flex items-center justify-center text-accent-foreground">
							💼
						</div>
					...
					<div class="flex-1">
						...
						<p class="text-xs text-accent mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
							CDI
						</p>
					</div>
				</div>
			...
			<div class="bg-muted rounded-lg p-6">
				...
				<div class="flex flex-wrap gap-3">
					...
					<button
						...
						onclick={() => window.open('https://steamcommunity.com/profiles/76561197978880770/', '_blank')}
					>
						<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
							<path d="M11.979 14.373c-1.378 0-2.492-1.113-2.492-2.492s1.114-2.492 2.492-2.492 2.492 1.113 2.492 2.492-1.113 2.492-2.492 2.492zm11.475-2.492c0 6.627-5.373 12-12 12s-12-5.373-12-12 5.373-12 12-12 12 5.373 12 12zm-5-.5c-.028-3.223-2.644-5.839-5.867-5.867v-2.063c4.36.028 7.902 3.57 7.93 7.93h-2.063zm-5.867-3.778c2.2.028 3.978 1.806 4.006 4.006h2.063c-.028-3.337-2.732-6.041-6.069-6.069v2.063z"/>
						</svg>
		...
		<div class="confetti-container">
			{#each Array(50) as _, i}
				<div 
					...
					"
				>
					<div class="w-3 h-3 rounded-full" style="background-color: {['#f87171', '#fbbf24', '#34d399', '#60a5fa', '#a78bfa', '#f472b6'][Math.floor(Math.random() * 6)]}"></div>
				</div>
			{/each}
		</div>
	</div>
