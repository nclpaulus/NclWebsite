<script lang="ts">
	...
	import {
		GARAGE_APPOINTMENTS_PATH,
		GARAGE_BILLING_PATH,
		GARAGE_INVENTORY_PATH
	} from '$lib/demos/garage';
...
<div class="container mx-auto px-4 py-8">
	...
	{:else}
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
			<a href={GARAGE_APPOINTMENTS_PATH} class="block group">
				<div
			...
			<a href={GARAGE_INVENTORY_PATH} class="block group">
				<div
					class="bg-card border border-border rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow group-hover:border-primary"
				>
					<div class="flex items-center mb-4">
			...
			<a href={GARAGE_BILLING_PATH} class="block group">
				<div
					class="bg-card border border-border rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow group-hover:border-primary"
				>
					<div class="flex items-center mb-4">
